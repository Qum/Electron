...
public class DefaultElectronicscustomService implements ElectronicscustomService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultElectronicscustomService.class);
	...
	{
		return DefaultElectronicscustomService.class.getResourceAsStream("/electronicscustom/sap-hybris-platform.png");
	}
